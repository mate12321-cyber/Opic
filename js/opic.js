/**
 * @file opic.js
 * @description [모드 3] OPIc 실전 질문 답변 및 5~7문장 분할 훈련 컨트롤러
 * - 에바(Eva)의 영어 질문 TTS 발화 및 실전 2회 청취 제한 시뮬레이션
 * - 답변 녹음 타이머 및 실시간 STT / 한글 번역 동기화
 * - IM1 수준 5~7문장 모범 답변 분할 뷰 및 문장별 원어민 TTS 재생
 * - 실전 3단 콤보(11-12-13번) 세트 출제 및 로컬 진행 상태 영속화
 *
 * @author Kim Hyo-sang
 * @version 2.2.5
 *
...
function playEvaQuestion(isAuto = false) {
  ...
  // [OPIc 공식 시험 규정 반영]:
  // 실제 시험장에서는 질문 청취 후 5초 이내에 1회에 한하여 'Replay' 버튼이 허용되어 총 2회까지만 들을 수 있습니다.
  // 실전 감각을 유지하기 위해 수동 재생 시도 시 2회 초과 청취를 원천 차단합니다.

/**
 * @file app.js
 * @description 메인 애플리케이션 진입점 및 이벤트 리스너 바인딩
 * - 클립보드 복사, 번역, AI 검색 팝업, 음성(TTS/STT) 재생 이벤트 등록
 * - 6대 학습 모드(문장 번역, 문법 퀴즈, 실전 OPIc, 만능 패턴, 필러 훈련, 자유 발화) 컨트롤러 연결
 * - 화면 라우팅 및 템플릿 로드 완료 후 라이프사이클 부팅 (initDashboard)
 *
 * @author Kim Hyo-sang
 * @version 2.2.5
 *

// Storage shim: mimics the window.storage API (Claude artifact sandbox)
      ...
      const SENTENCES = [
        ...
        {
          cat: "자기소개",
          ko: "저는 충남 천안에 살고 있습니다.",
          en: "I live in Cheonan, in South Chungcheong Province.",
          tip: "'live in + 도시'가 가장 자연스러운 표현이에요.",
        },
        {
          cat: "자기소개",
          ko: "저는 삼성전자에서 전기 설비를 관리하는 일을 해요.",
          en: "I manage electrical equipment at Samsung Electronics.",
          tip: "직무는 'manage / handle / work on'으로 간단히 표현하세요.",
        },
        {
          cat: "자기소개",
        ...
        },
        {
          cat: "자기소개",
          ko: "저는 형제가 한 명 있어요.",
          en: "I have one sibling.",
          tip: "가족 관계는 'have + 명사'로 간단히 말해요.",
        },
        {
          cat: "자기소개",
          ko: "제 취미는 여러 가지예요.",
          en: "I have several hobbies.",
          tip: "'several'은 '여러 가지'라는 뜻이에요.",
        },
        {
          cat: "자기소개",
          ko: "저는 회사원이에요.",
          en: "I'm an office worker.",
          tip: "직업은 'I'm a/an + 직업'으로 말해요.",
        },
        {
          cat: "자기소개",
          ko: "저는 활발한 성격이에요.",
          en: "I have an outgoing personality.",
          tip: "'outgoing'은 '활발한'이라는 뜻이에요.",
        },
        ...
        {
          cat: "집/주거",
          ko: "저는 최근에 새 아파트로 이사할 준비를 하고 있어요.",
          en: "I'm getting ready to move into a new apartment.",
          tip: "가까운 미래 계획은 현재진행형으로 말해요.",
        },
        {
          cat: "집/주거",
          ko: "저희 아파트는 방이 세 개 있어요.",
          en: "Our apartment has three bedrooms.",
          tip: "'has' 뒤에 단순히 개수만 붙이면 돼요.",
        },
        {
          cat: "집/주거",
          ko: "저는 주말마다 집을 청소해요.",
          en: "I clean the house every weekend.",
          tip: "3인칭 단수가 아니라 'I' 주어라서 동사에 -s가 붙지 않아요.",
        },
        {
          cat: "집/주거",
          ko: "저는 지금 사는 곳이 마음에 들어요.",
          en: "I like where I currently live.",
          tip: "'where I live'는 '내가 사는 곳'이라는 뜻이에요.",
        },
        {
          cat: "집/주거",
        ...
        },
        {
          ...
          ko: "저희 집은 커요.",
          en: "My house is big.",
          tip: "짧게 'be동사 + 형용사'로 상태를 말해요.",
        },
        {
          cat: "집/주거",
          ko: "저는 아파트에 살아요.",
          en: "I live in an apartment.",
          tip: "'live in + 장소'는 기본 문장이에요.",
        },

        {
          ...
          tip: "반복되는 업무는 단순 현재시제로 말해요.",
        },
        {
          cat: "직장/업무",
          ko: "저희 팀에는 다섯 명의 동료가 있어요.",
          en: "There are five colleagues on my team.",
          tip: "복수 명사 앞에서는 'There are'를 써요.",
        },
        {
          cat: "직장/업무",
          ko: "저는 야간 근무를 할 때 조금 피곤해요.",
          en: "I feel a little tired when I work night shifts.",
          tip: "짧게, 있는 그대로 느낌을 말하면 충분해요.",
        },
        {
          cat: "직장/업무",
          ko: "문제가 생기면 저는 바로 상사에게 보고해요.",
          en: "When there's a problem, I report it to my supervisor right away.",
          tip: "'when절 + 주절' 구조로 습관적 행동을 설명해요.",
        },
        {
          cat: "직장/업무",
          ko: "저는 점심시간에 동료들과 식사를 해요.",
          en: "I have lunch with my colleagues during lunch break.",
          tip: "'during + 명사'로 시간대를 나타내요.",
        },
        {
          cat: "직장/업무",
          ko: "저는 매달 업무 보고서를 작성해요.",
          en: "I write a work report every month.",
          tip: "'every month'는 반복 주기를 나타내요.",
        },
        {
          cat: "직장/업무",
          ko: "저는 매일 출근해요.",
          en: "I go to work every day.",
          tip: "'go to work'는 출근한다는 뜻이에요.",
        },
        {
          cat: "직장/업무",
          ko: "제 직장은 커요.",
          en: "My workplace is big.",
          tip: "짧게 'be동사 + 형용사'로 표현해요.",
        },

        {
          cat: "취미",
          ko: "저는 시간이 날 때 주식 투자에 관심이 있어요.",
          en: "I'm interested in stock investing in my free time.",
          tip: "'be interested in + 명사/동명사' 패턴을 기억하세요.",
        },
        {
          cat: "취미",
          ko: "저는 앱을 만드는 것을 좋아해요.",
          en: "I like making apps.",
          tip: "동사구를 명사처럼 쓸 때는 -ing 형태를 써요.",
        },
        {
          cat: "취미",
          ko: "저는 최근에 웹사이트 만드는 취미를 시작했어요.",
          en: "I recently started a hobby of building websites.",
          tip: "'recently'는 과거시제와 잘 어울려요.",
        },
        {
          cat: "취미",
          ko: "저는 한국 전통문화에 관심이 많아요.",
          en: "I have a lot of interest in traditional Korean culture.",
          tip: "명사구를 쓸 때는 순서(traditional Korean culture)에 주의하세요.",
        },
        {
          cat: "취미",
          ko: "저는 주말에 새로운 취미를 시도해보는 것을 좋아해요.",
          en: "I like trying new hobbies on weekends.",
          tip: "'try -ing'는 시도해본다는 뜻이에요.",
        },
        {
          cat: "취미",
          ko: "저는 어렸을 때부터 그림 그리는 것을 좋아했어요.",
          en: "I've liked drawing since I was young.",
          tip: "'since + 과거 시점'은 현재완료와 함께 써요.",
        },
        {
          cat: "취미",
          ko: "저는 취미가 많아요.",
          en: "I have many hobbies.",
          tip: "'have many + 명사'로 간단히 말해요.",
        },
        {
          cat: "취미",
          ko: "저는 책 읽는 것을 좋아해요.",
          en: "I like reading books.",
          tip: "'like -ing'로 좋아하는 것을 표현해요.",
        },

        {
          cat: "일상",
          ko: "저는 보통 아침 7시에 일어나요.",
          en: "I usually get up at 7 in the morning.",
          tip: "빈도부사 'usually'는 동사 앞에 와요.",
        },
        {
          cat: "일상",
          ko: "저는 출근하기 전에 커피를 한 잔 마셔요.",
          en: "I drink a cup of coffee before I go to work.",
          tip: "주어가 'I'라서 동사 원형을 그대로 써요.",
        },
        {
          cat: "일상",
          ko: "교대 근무 때문에 제 일정은 매주 바뀌어요.",
          en: "My schedule changes every week because of my shift work.",
          tip: "'because of + 명사구'로 이유를 간단히 붙여요.",
        },
        {
          cat: "일상",
          ko: "저는 퇴근한 후에 보통 운동을 해요.",
          en: "I usually work out after I get off work.",
          tip: "'after + 주어 + 동사' 순서를 기억하세요.",
        },
        {
          cat: "일상",
          ko: "저는 자기 전에 휴대폰을 확인해요.",
          en: "I check my phone before I go to bed.",
          tip: "'before + 주어 + 동사'로 순서를 표현해요.",
        },
        {
          cat: "일상",
          ko: "저는 하루 일과를 계획하는 것을 좋아해요.",
          en: "I like planning my daily schedule.",
          tip: "'daily schedule'은 '하루 일과'라는 뜻이에요.",
        },
        {
          cat: "일상",
          ko: "저는 매일 아침을 먹어요.",
          en: "I eat breakfast every day.",
          tip: "'eat breakfast'는 아침을 먹는다는 뜻이에요.",
        },
        {
          cat: "일상",
          ko: "저는 저녁에 쉬어요.",
        ...
        {
          cat: "여가/주말",
          ko: "저는 주말에 가족과 시간을 보내는 것을 좋아해요.",
          en: "I like spending time with my family on weekends.",
          tip: "'spend time with + 사람'은 자주 쓰는 표현이에요.",
        },
        {
          cat: "여가/주말",
          ko: "지난 주말에 저는 아내와 쇼핑을 하러 갔어요.",
          en: "Last weekend, I went shopping with my partner.",
          tip: "과거의 특정 시점은 단순 과거로 말해요.",
        },
        {
          cat: "여가/주말",
          ko: "저는 가끔 혼자 카페에 가서 책을 읽어요.",
          en: "I sometimes go to a cafe alone and read a book.",
          tip: "'sometimes'는 반복되지만 매번은 아닌 행동에 써요.",
        },
        {
          cat: "여가/주말",
          ko: "저는 주말에 늦잠을 자는 것을 좋아해요.",
          en: "I like sleeping in on weekends.",
          tip: "'sleep in'은 늦잠을 잔다는 뜻이에요.",
        },
        {
          cat: "여가/주말",
          ko: "저는 가끔 아무것도 하지 않고 집에서 쉬어요.",
          en: "I sometimes just relax at home and do nothing.",
          tip: "'and do nothing'으로 아무것도 안 한다는 의미를 더해요.",
        },
        {
          cat: "여가/주말",
          ko: "저는 주말을 좋아해요.",
          en: "I like weekends.",
          tip: "'like + 명사'로 간단히 말해요.",
        },
        {
          cat: "여가/주말",
          ko: "저는 주말에 쉬어요.",
          en: "I rest on weekends.",
          tip: "'on weekends'는 주말마다라는 뜻이에요.",
        },

        {
          cat: "음식",
          ko: "저는 매운 음식을 좋아하는 편이에요.",
          en: "I tend to like spicy food.",
          tip: "'tend to'로 성향을 부드럽게 표현할 수 있어요.",
        },
        {
          cat: "음식",
          ko: "저희 집 근처에 맛있는 식당이 하나 있어요.",
          en: "There's a nice restaurant near my house.",
          tip: "위치를 말할 때도 'There's a ~ near'가 자연스러워요.",
        },
        {
          cat: "음식",
          ko: "저는 요즘 아침을 자주 걸러요.",
          en: "I often skip breakfast these days.",
          tip: "'these days'는 요즘의 습관을 말할 때 좋아요.",
        },
        {
          cat: "음식",
          ko: "저는 채소를 많이 먹으려고 노력해요.",
          en: "I try to eat a lot of vegetables.",
          tip: "'try to + 동사원형'으로 노력을 표현해요.",
        },
        {
          cat: "음식",
          ko: "저는 친구들과 함께 저녁을 먹는 것을 좋아해요.",
          en: "I like having dinner with friends.",
          tip: "'have dinner'는 저녁을 먹는다는 뜻이에요.",
        },
        {
          cat: "음식",
          ko: "저는 한식을 좋아해요.",
...

        {
          ...
          tip: "두 형용사를 'and'로 이어서 간단히 설명하세요.",
        },
        {
          cat: "날씨/계절",
          ko: "저는 봄과 가을을 가장 좋아해요.",
          en: "I like spring and fall the most.",
          tip: "'the most'는 문장 끝에 붙여 최상급을 표현해요.",
        },
        {
          cat: "날씨/계절",
          ko: "저는 겨울에 눈이 오는 것을 좋아해요.",
          en: "I like it when it snows in winter.",
          tip: "'it when it snows'처럼 날씨는 'it'을 주어로 써요.",
        },
        {
          cat: "날씨/계절",
          ko: "요즘 날씨가 점점 더워지고 있어요.",
          en: "The weather is getting hotter these days.",
          tip: "'get + 비교급'으로 변화하는 상태를 표현해요.",
        },
        {
          cat: "날씨/계절",
          ko: "저는 여름을 좋아해요.",
        ...
        },
        {
          ...
          tip: "'be동사 + nice'로 상태를 표현해요.",
        },

        {
          cat: "쇼핑",
          ko: "저는 물건을 살 때 가격을 꼼꼼히 비교해요.",
          en: "I carefully compare prices when I buy things.",
          tip: "부사 'carefully'는 동사 앞이나 뒤 모두 가능해요.",
        },
        {
          cat: "쇼핑",
          ko: "저는 온라인 쇼핑보다 직접 가서 사는 것을 더 좋아해요.",
          en: "I prefer shopping in person to shopping online.",
          tip: "'prefer A to B' 비교 구조를 기억하세요.",
        },
        {
          cat: "쇼핑",
          ko: "저는 세일 기간에 옷을 많이 사요.",
          en: "I buy a lot of clothes during sale season.",
          tip: "'during + 명사'로 기간을 표현해요.",
        },
        {
          cat: "쇼핑",
          ko: "저는 필요한 것만 사려고 노력해요.",
          en: "I try to buy only what I need.",
          tip: "'what I need'는 '내가 필요한 것'이라는 뜻이에요.",
        },
        {
          cat: "쇼핑",
          ko: "저는 쇼핑을 좋아해요.",
        ...
        },
        {
          cat: "쇼핑",
          ko: "저는 가끔 옷을 사요.",
          en: "I sometimes buy clothes.",
          tip: "'sometimes'는 동사 앞에 위치해요.",
        },

        {
          cat: "여행",
          ko: "저는 작년에 가족과 함께 제주도에 다녀왔어요.",
          en: "I went to Jeju Island with my family last year.",
          tip: "'last year'가 있으므로 과거시제를 써요.",
        },
        {
          cat: "여행",
          ko: "저는 여행 갈 때 계획을 미리 세우는 편이에요.",
          en: "I tend to plan ahead when I travel.",
          tip: "습관적 성향은 'tend to'로 부드럽게 표현해요.",
        },
        {
          cat: "여행",
          ko: "저는 새로운 곳을 방문하는 것을 좋아해요.",
          en: "I like visiting new places.",
          tip: "'visit + 장소'로 방문한다는 뜻을 나타내요.",
        },
        {
          cat: "여행",
          ko: "저는 여행 중에 사진을 많이 찍어요.",
          en: "I take a lot of photos while traveling.",
          tip: "'while -ing'로 여행하는 동안이라는 뜻을 표현해요.",
        },
        {
          cat: "여행",
          ko: "저는 여행을 좋아해요.",
        ...
        },
        {
          ...
          ko: "저는 여행을 자주 가요.",
          en: "I travel often.",
          tip: "'often'은 동사 뒤에도 올 수 있어요.",
        },

        {
          cat: "카페가기",
          ko: "저는 커피를 정말 좋아해요.",
          en: "I really like coffee.",
          tip: "'really'는 like 앞에 붙여 강조해요.",
        },
        {
          cat: "카페가기",
          ko: "저는 일주일에 두세 번 카페에 가요.",
          en: "I go to a cafe two or three times a week.",
          tip: "빈도는 'times a week'로 문장 끝에 붙여요.",
        },
        {
          cat: "카페가기",
          ko: "저는 보통 아이스 아메리카노를 마셔요.",
          en: "I usually drink iced Americano.",
          tip: "메뉴 이름은 그대로 영어로 써도 괜찮아요.",
        },
        {
          cat: "카페가기",
          ko: "저희 동네에는 조용한 카페가 하나 있어요.",
          en: "There's a quiet cafe in my neighborhood.",
          tip: "'There's a ~ in my neighborhood'로 위치를 소개해요.",
        },
        {
          cat: "카페가기",
          ko: "저는 카페에서 친구를 만나서 얘기하는 걸 좋아해요.",
          en: "I like meeting friends and chatting at a cafe.",
          tip: "'meeting'과 'chatting'처럼 동명사를 나란히 써요.",
        },
        {
          cat: "카페가기",
          ko: "저는 카페에서 책을 읽는 것을 좋아해요.",
          en: "I like reading books at a cafe.",
          tip: "'read books'는 책을 읽는다는 뜻이에요.",
        },
        {
          cat: "카페가기",
          ko: "저는 노트북을 가지고 카페에 가서 일을 해요.",
          en: "I bring my laptop to a cafe and work there.",
          tip: "'bring + 물건 + to + 장소'로 가져간다는 뜻을 표현해요.",
        },
        {
          cat: "카페가기",
          ko: "저는 카페를 좋아해요.",
        ...
        },
        {
          ...
          ko: "저는 커피를 마셔요.",
          en: "I drink coffee.",
          tip: "짧은 문장으로 습관을 표현해요.",
        },
        {
          cat: "카페가기",
          ko: "저는 카페에서 케이크나 빵을 자주 먹어요.",
          en: "I often eat cake or bread at a cafe.",
          tip: "'cake or bread'처럼 or로 선택지를 나열해요.",
        },
        {
          cat: "카페가기",
          ko: "저는 줄을 서서 커피를 주문해요.",
          en: "I wait in line to order coffee.",
          tip: "'wait in line'은 줄을 선다는 뜻이에요.",
        },
        {
          cat: "카페가기",
          ko: "저는 겨울에는 따뜻한 라떼를 마셔요.",
          en: "I drink a warm latte in winter.",
          tip: "'in winter'로 계절을 표현해요.",
        },
        {
          cat: "카페가기",
          ko: "저는 카페의 와이파이를 자주 이용해요.",
          en: "I often use the cafe's wifi.",
          tip: "'cafe's wifi'처럼 소유격 's를 붙여요.",
        },
        {
          cat: "카페가기",
          ko: "저는 시험 기간에는 카페에서 공부해요.",
          en: "I study at a cafe during exam periods.",
          tip: "'during + 명사'로 기간을 표현해요.",
        },
        {
          cat: "카페가기",
          ko: "저는 단골 카페가 하나 있어요.",
          en: "I have a regular cafe I go to.",
          tip: "'regular cafe'는 단골 카페라는 뜻이에요.",
        },
        {
          cat: "카페가기",
          ko: "저는 카페 음악 듣는 것을 좋아해요.",
          en: "I like listening to the music at cafes.",
          tip: "'listen to the music'을 기억해두세요.",
        },
        {
          cat: "카페가기",
          ko: "저는 커피값이 비싸다고 생각해요.",
          en: "I think coffee prices are expensive.",
          tip: "'I think + 절'로 의견을 말해요.",
        },
        {
          cat: "카페가기",
          ko: "저는 혼자 카페에 가는 것도 좋아해요.",
          en: "I also like going to a cafe alone.",
          tip: "'also'는 동사 앞에 위치해요.",
        },
        {
          cat: "카페가기",
          ko: "저는 주말 아침에 카페에서 여유를 즐겨요.",
          en: "I enjoy relaxing at a cafe on weekend mornings.",
          tip: "'enjoy -ing'로 즐기는 활동을 표현해요.",
        },

        {
          cat: "공원가기",
          ko: "저는 주말마다 공원에 산책하러 가요.",
          en: "I go for a walk in the park every weekend.",
          tip: "'go for a walk'는 산책을 뜻하는 자연스러운 표현이에요.",
        },
        {
          cat: "공원가기",
          ko: "저희 집 근처에 큰 공원이 있어요.",
          en: "There's a big park near my house.",
          tip: "'near my house'는 위치를 간단히 설명해요.",
        },
        {
          cat: "공원가기",
          ko: "저는 공원에서 자전거를 타는 것을 좋아해요.",
          en: "I like riding a bike in the park.",
          tip: "'like -ing'로 취미를 말해요.",
        },
        {
          cat: "공원가기",
          ko: "저는 가끔 공원 벤치에 앉아서 쉬어요.",
          en: "I sometimes sit on a bench in the park and rest.",
          tip: "두 동작(sit, rest)을 'and'로 이어요.",
        },
        {
          cat: "공원가기",
          ko: "날씨가 좋으면 저는 공원에서 도시락을 먹어요.",
          en: "When the weather is nice, I eat lunch in the park.",
          tip: "'When + 조건절'로 상황을 먼저 말해요.",
        },
        {
          cat: "공원가기",
          ko: "저는 공원에서 운동하는 사람들을 자주 봐요.",
          en: "I often see people exercising in the park.",
          tip: "'see + 사람 + -ing'로 진행 중인 동작을 나타내요.",
        },
        {
          cat: "공원가기",
          ko: "저는 강아지와 함께 공원에 가요.",
          en: "I go to the park with my dog.",
          tip: "'with + 대상'으로 함께하는 존재를 표현해요.",
        },
        {
          cat: "공원가기",
          ko: "저는 공원을 좋아해요.",
        ...
        },
        {
          cat: "공원가기",
          ko: "저는 공원에 자주 가요.",
          en: "I go to the park often.",
          tip: "짧게 'go to + 장소 + often'으로 표현해요.",
        },

        {
          ...
          tip: "'watch a movie'가 기본 표현이에요.",
        },
        {
          cat: "영화보기",
          ko: "저는 한 달에 한 번 영화관에 가요.",
          en: "I go to the movie theater once a month.",
          tip: "'once a month'로 빈도를 말해요.",
        },
        {
          cat: "영화보기",
          ko: "저는 액션 영화를 가장 좋아해요.",
          en: "I like action movies the most.",
          tip: "'the most'는 문장 끝에서 최상급을 표현해요.",
        },
        {
          cat: "영화보기",
          ko: "저는 지난주에 친구와 영화를 봤어요.",
          en: "I watched a movie with a friend last week.",
          tip: "'last week'가 있으니 과거시제를 써요.",
        },
        {
          cat: "영화보기",
          ko: "저는 집에서 영화를 볼 때 팝콘을 먹어요.",
          en: "I eat popcorn when I watch movies at home.",
          tip: "습관적 행동은 현재시제로 말해요.",
        },
        {
          cat: "영화보기",
          ko: "저는 영화관에서 큰 스크린으로 보는 것을 좋아해요.",
          en: "I like watching movies on a big screen at the theater.",
          tip: "'on a big screen'으로 수단을 표현해요.",
        },
        {
          cat: "영화보기",
          ko: "저는 새로 나온 영화를 자주 확인해요.",
          en: "I often check for new movie releases.",
          tip: "'check for + 명사'로 확인한다는 뜻을 나타내요.",
        },
        {
          cat: "영화보기",
          ko: "저는 영화를 좋아해요.",
...

        {
          ...
          tip: "'listen to music'을 통째로 기억해두세요.",
        },
        {
          cat: "음악감상",
          ko: "저는 출근할 때 음악을 들어요.",
          en: "I listen to music when I go to work.",
          tip: "'when + 주어 + 동사'로 상황을 붙여요.",
        },
        {
          cat: "음악감상",
          ko: "저는 조용한 음악을 좋아하는 편이에요.",
          en: "I tend to like calm music.",
          tip: "'tend to'로 취향을 부드럽게 말해요.",
        },
        {
          cat: "음악감상",
          ko: "저는 스마트폰으로 음악을 자주 들어요.",
          en: "I often listen to music on my smartphone.",
          tip: "'on my smartphone'으로 수단을 표현해요.",
        },
        {
          cat: "음악감상",
          ko: "저는 스트레스를 받을 때 음악을 들으면서 쉬어요.",
          en: "When I'm stressed, I relax by listening to music.",
          tip: "'by -ing'는 방법을 설명할 때 써요.",
        },
        {
          cat: "음악감상",
          ko: "저는 다양한 장르의 음악을 들어요.",
          en: "I listen to various genres of music.",
          tip: "'various genres of'로 다양한 종류를 표현해요.",
        },
        {
          cat: "음악감상",
          ko: "저는 플레이리스트 만드는 것을 좋아해요.",
          en: "I like making playlists.",
          tip: "'make a playlist'는 자주 쓰는 표현이에요.",
        },
        {
          cat: "음악감상",
          ko: "저는 음악을 좋아해요.",
        ...
        },
        {
          cat: "음악감상",
          ko: "저는 노래를 자주 들어요.",
          en: "I listen to songs often.",
          tip: "'listen to + 명사'는 기본 표현이에요.",
        },

        {
          cat: "운동하기",
          ko: "저는 일주일에 세 번 헬스장에 가요.",
          en: "I go to the gym three times a week.",
          tip: "빈도는 'times a week'로 문장 끝에 붙여요.",
        },
        {
          cat: "운동하기",
          ko: "저는 퇴근한 후에 러닝머신에서 뛰어요.",
          en: "I run on the treadmill after I get off work.",
          tip: "'after + 주어 + 동사'로 순서를 나타내요.",
        },
        {
          cat: "운동하기",
          ko: "저는 운동하는 것을 별로 좋아하지 않았지만 요즘은 재미있어요.",
          en: "I didn't use to like exercising, but it's fun these days.",
          tip: "'didn't use to'는 예전 습관이 지금은 아님을 말해요.",
        },
        {
          cat: "운동하기",
          ko: "저는 운동 후에 몸이 가벼워지는 느낌이 좋아요.",
          en: "I like how light my body feels after exercising.",
          tip: "'how + 형용사 + 주어 + 동사'로 느낌을 설명해요.",
        },
        {
          cat: "운동하기",
          ko: "저는 주로 근력 운동을 해요.",
          en: "I mainly do strength training.",
          tip: "'mainly'는 주로 하는 활동을 말할 때 써요.",
        },
        {
          cat: "운동하기",
          ko: "저는 운동을 시작한 지 1년 정도 됐어요.",
          en: "I've been exercising for about a year.",
          tip: "'have been -ing for'는 계속된 기간을 나타내요.",
        },
        {
          cat: "운동하기",
          ko: "저는 운동 계획을 세우고 지키려고 노력해요.",
          en: "I try to make and stick to a workout plan.",
          tip: "'stick to a plan'은 계획을 지킨다는 뜻이에요.",
        },
        {
          cat: "운동하기",
          ko: "저는 운동을 좋아해요.",
          en: "I like exercising.",
          tip: "'like + 명사/동명사'로 간단히 말해요.",
        },
        {
          cat: "운동하기",
          ko: "저는 매일 운동해요.",
          en: "I exercise every day.",
          tip: "'every day'는 매일이라는 뜻이에요.",
        },

        {
          cat: "요리하기",
          ko: "저는 주말에 가끔 요리를 해요.",
          en: "I sometimes cook on weekends.",
          tip: "'sometimes'는 동사 앞에 위치해요.",
        },
        {
          cat: "요리하기",
          ko: "저는 간단한 한식을 만들 수 있어요.",
          en: "I can make simple Korean dishes.",
          tip: "능력은 'can + 동사원형'으로 표현해요.",
        },
        {
          cat: "요리하기",
          ko: "저는 요리할 때 유튜브 레시피를 참고해요.",
          en: "I follow YouTube recipes when I cook.",
          tip: "'follow a recipe'는 레시피를 따라 한다는 뜻이에요.",
        },
        {
          cat: "요리하기",
          ko: "저는 요리한 후에 설거지하는 것이 제일 귀찮아요.",
          en: "Doing the dishes after cooking is the most annoying part.",
          tip: "동명사구(Doing the dishes)가 문장의 주어가 될 수 있어요.",
        },
        {
          cat: "요리하기",
          ko: "저는 매운 음식 요리하는 것을 좋아해요.",
          en: "I like cooking spicy food.",
          tip: "'like -ing'로 좋아하는 활동을 말해요.",
        },
        {
          cat: "요리하기",
          ko: "저는 새로운 레시피에 도전하는 것을 좋아해요.",
          en: "I like trying out new recipes.",
          tip: "'try out'은 시도해본다는 뜻이에요.",
        },
        {
          cat: "요리하기",
          ko: "저는 요리하는 동안 음악을 틀어놔요.",
          en: "I play music while I cook.",
          tip: "'while + 주어 + 동사'로 동시 동작을 나타내요.",
        },
        {
          cat: "요리하기",
          ko: "저는 요리를 좋아해요.",
          en: "I like cooking.",
          tip: "'like + 동명사'로 간단히 말해요.",
        },
        {
          cat: "요리하기",
          ko: "저는 가끔 요리해요.",
        ...
        {
          cat: "국내여행",
          ko: "저는 국내 여행을 자주 다니는 편이에요.",
          en: "I tend to travel domestically often.",
          tip: "'tend to'로 성향을, 'domestically'로 국내를 표현해요.",
        },
        {
          cat: "국내여행",
          ko: "저는 지난달에 부산으로 여행을 다녀왔어요.",
          en: "I went on a trip to Busan last month.",
          tip: "'go on a trip to + 장소'가 자연스러운 표현이에요.",
        },
        {
          cat: "국내여행",
          ko: "저는 여행 갈 때 보통 기차를 타요.",
          en: "I usually take a train when I travel.",
          tip: "'take a train/bus/car'로 교통수단을 말해요.",
        },
        {
          cat: "국내여행",
          ko: "저는 바다가 있는 도시에 가는 것을 좋아해요.",
          en: "I like visiting cities near the sea.",
          tip: "'near the sea'로 위치를 설명해요.",
        },
        {
          cat: "국내여행",
          ko: "저는 여행할 때 그 지역 음식을 꼭 먹어봐요.",
          en: "When I travel, I always try the local food.",
          tip: "'try local food'는 현지 음식을 먹어본다는 뜻이에요.",
        },
        {
          cat: "국내여행",
          ko: "저는 여행 계획을 세우는 과정 자체를 즐겨요.",
          en: "I enjoy the process of planning a trip.",
          tip: "'the process of -ing'로 과정을 표현해요.",
        },
        {
          cat: "국내여행",
          ko: "저는 국내 여행할 때 렌터카를 이용해요.",
          en: "I use a rental car when I travel domestically.",
          tip: "'rental car'는 렌터카를 뜻해요.",
        },
        {
          cat: "국내여행",
          ko: "저는 국내 여행을 좋아해요.",
          en: "I like traveling in Korea.",
          tip: "'traveling in + 나라'로 간단히 말해요.",
        },
        {
          cat: "국내여행",
          ko: "저는 부산을 좋아해요.",
          en: "I like Busan.",
          tip: "'like + 지명'으로 간단히 말해요.",
        },

        {
          cat: "반려동물",
          ko: "저는 강아지 한 마리를 키우고 있어요.",
          en: "I have a dog.",
          tip: "반려동물을 기른다는 표현은 간단히 'have'로 써요.",
        },
        {
          cat: "반려동물",
          ko: "저희 강아지는 산책하는 것을 정말 좋아해요.",
          en: "My dog really loves going for walks.",
          tip: "'go for a walk'는 산책을 뜻해요.",
        },
        {
          cat: "반려동물",
          ko: "저는 매일 아침 강아지에게 밥을 줘요.",
          en: "I feed my dog every morning.",
          tip: "'feed + 대상'으로 밥을 준다는 뜻이에요.",
        },
        {
          cat: "반려동물",
          ko: "저는 퇴근하면 가장 먼저 강아지와 놀아줘요.",
          en: "When I get home from work, I play with my dog first.",
          tip: "'play with + 대상'을 기억하세요.",
        },
        {
          cat: "반려동물",
          ko: "저희 강아지는 낯선 사람을 보면 짖어요.",
          en: "My dog barks when it sees a stranger.",
          tip: "동물 주어는 'it'으로 받을 수 있어요.",
        },
        {
          cat: "반려동물",
          ko: "저는 주말마다 강아지를 목욕시켜요.",
          en: "I bathe my dog every weekend.",
          tip: "'bathe + 대상'으로 목욕시킨다는 뜻을 나타내요.",
        },
        {
          cat: "반려동물",
          ko: "저는 강아지 덕분에 외롭지 않아요.",
          en: "I don't feel lonely thanks to my dog.",
          tip: "'thanks to + 명사'로 이유를 긍정적으로 표현해요.",
        },
        {
          cat: "반려동물",
          ko: "저는 강아지를 좋아해요.",
        ...
        },
        {
          ...
          ko: "저희 강아지는 귀여워요.",
          en: "My dog is cute.",
          tip: "'be동사 + cute'로 상태를 표현해요.",
        },

        {
          cat: "공연보기",
          ko: "저는 가끔 공연을 보러 가요.",
          en: "I sometimes go to see a performance.",
          tip: "'go to see a performance'로 공연 관람을 표현해요.",
        },
        {
          cat: "공연보기",
          ko: "저는 지난달에 뮤지컬을 봤어요.",
          en: "I watched a musical last month.",
          tip: "과거의 특정 시점은 단순 과거로 말해요.",
        },
        {
          cat: "공연보기",
          ko: "저는 공연을 볼 때 앞자리에 앉는 것을 좋아해요.",
          en: "I like sitting in the front row when I watch a performance.",
          tip: "'sit in the front row'는 앞자리에 앉는다는 뜻이에요.",
        },
        {
          cat: "공연보기",
          ko: "저는 친구와 함께 공연을 보러 가요.",
          en: "I go to see performances with a friend.",
          tip: "'with a friend'로 함께하는 사람을 붙여요.",
        },
        {
          cat: "공연보기",
          ko: "저는 공연이 끝나면 기분이 좋아져요.",
          en: "I feel great after a performance ends.",
          tip: "'after + 명사/절'로 시점을 표현해요.",
        },
        {
          cat: "공연보기",
          ko: "저는 공연을 예매할 때 미리 후기를 찾아봐요.",
          en: "I check reviews before booking a performance.",
          tip: "'before -ing'로 순서를 표현해요.",
        },
        {
          cat: "공연보기",
          ko: "저는 다양한 장르의 공연을 보러 다녀요.",
          en: "I go see performances of various genres.",
          tip: "'go see'는 보러 간다는 뜻이에요.",
        },
        {
          cat: "공연보기",
          ko: "저는 공연을 좋아해요.",
          en: "I like performances.",
          tip: "'like + 명사'로 간단히 말해요.",
        },
        {
          cat: "공연보기",
        ...
        {
          cat: "콘서트 보기",
          ko: "저는 콘서트에 가는 것을 좋아해요.",
          en: "I like going to concerts.",
          tip: "'go to a concert'을 기억해두세요.",
        },
        {
          cat: "콘서트 보기",
          ko: "저는 일 년에 두 번 정도 콘서트에 가요.",
          en: "I go to a concert about twice a year.",
          tip: "'about + 빈도'로 대략적인 횟수를 말해요.",
        },
        {
          cat: "콘서트 보기",
          ko: "저는 좋아하는 가수의 콘서트 티켓을 예매했어요.",
          en: "I booked tickets for my favorite singer's concert.",
          tip: "'book a ticket'은 티켓을 예매한다는 뜻이에요.",
        },
        {
          cat: "콘서트 보기",
          ko: "저는 콘서트에서 노래를 따라 부르는 것을 좋아해요.",
          en: "I like singing along at concerts.",
          tip: "'sing along'은 노래를 따라 부른다는 뜻이에요.",
        },
        {
          cat: "콘서트 보기",
          ko: "저는 콘서트가 끝난 후 목이 쉬어요.",
          en: "My voice gets hoarse after a concert.",
          tip: "'get + 형용사'로 상태 변화를 말해요.",
        },
        {
          cat: "콘서트 보기",
          ko: "저는 좋아하는 가수의 새 앨범이 나오면 콘서트를 기다려요.",
          en: "I look forward to concerts when my favorite singer releases a new album.",
          tip: "'look forward to + 명사'로 기대감을 표현해요.",
        },
        {
          cat: "콘서트 보기",
          ko: "저는 콘서트에서 응원봉을 흔들어요.",
          en: "I wave a light stick at concerts.",
          tip: "'wave a light stick'은 응원봉을 흔든다는 뜻이에요.",
        },
        {
          cat: "콘서트 보기",
          ko: "저는 콘서트를 좋아해요.",
...

        {
          cat: "캠핑하기",
          ko: "저는 여름마다 캠핑을 가요.",
          en: "I go camping every summer.",
          tip: "'go camping'은 캠핑을 간다는 뜻이에요.",
        },
        {
          cat: "캠핑하기",
          ko: "저는 가족과 함께 텐트를 치고 잠을 자요.",
          en: "I set up a tent and sleep with my family.",
          tip: "'set up a tent'는 텐트를 친다는 뜻이에요.",
        },
        {
          cat: "캠핑하기",
          ko: "저는 캠핑할 때 모닥불 앞에서 이야기하는 것을 좋아해요.",
          en: "I like talking by the campfire when I go camping.",
          tip: "'by the campfire'로 장소를 표현해요.",
        },
        {
          cat: "캠핑하기",
          ko: "저는 캠핑장에서 고기를 구워 먹어요.",
          en: "I grill meat at the campsite.",
          tip: "'grill meat'는 고기를 굽는다는 뜻이에요.",
        },
        {
          cat: "캠핑하기",
          ko: "저는 캠핑 갈 때 짐을 많이 챙겨요.",
          en: "I pack a lot of gear when I go camping.",
          tip: "'pack gear'는 장비를 챙긴다는 뜻이에요.",
        },
        {
          cat: "캠핑하기",
          ko: "저는 캠핑 갈 때 날씨를 미리 확인해요.",
          en: "I check the weather in advance before going camping.",
          tip: "'in advance'는 미리라는 뜻이에요.",
        },
        {
          cat: "캠핑하기",
          ko: "저는 캠핑장에서 별을 보는 것을 좋아해요.",
          en: "I like watching the stars at the campsite.",
          tip: "'watch the stars'는 별을 본다는 뜻이에요.",
        },
        {
          cat: "캠핑하기",
          ko: "저는 캠핑을 좋아해요.",
        ...
        },
        {
          cat: "캠핑하기",
          ko: "저는 여름에 캠핑을 가요.",
          en: "I go camping in summer.",
          tip: "'in summer'로 계절을 표현해요.",
        },

        {
          cat: "해변가기",
          ko: "저는 여름에 해변에 가는 것을 좋아해요.",
          en: "I like going to the beach in summer.",
          tip: "'go to the beach'를 기억해두세요.",
        },
        {
          cat: "해변가기",
          ko: "저는 해변에서 산책하는 것을 좋아해요.",
          en: "I like walking along the beach.",
          tip: "'walk along the beach'는 해변을 따라 걷는다는 뜻이에요.",
        },
        {
          cat: "해변가기",
          ko: "저는 해변에서 노을을 보는 것을 좋아해요.",
          en: "I like watching the sunset at the beach.",
          tip: "'watch the sunset'을 기억해두세요.",
        },
        {
          cat: "해변가기",
          ko: "저는 해변에서 수영을 하지는 않지만 물놀이는 해요.",
          en: "I don't swim at the beach, but I do play in the water.",
          tip: "'but I do' 강조 표현으로 대조를 나타내요.",
        },
        {
          cat: "해변가기",
          ko: "저는 해변 근처 식당에서 회를 먹는 것을 좋아해요.",
          en: "I like eating raw fish at restaurants near the beach.",
          tip: "'near the beach'로 위치를 붙여요.",
        },
        {
          cat: "해변가기",
          ko: "저는 해변에서 조개를 줍는 것을 좋아해요.",
          en: "I like collecting seashells at the beach.",
          tip: "'collect seashells'는 조개를 줍는다는 뜻이에요.",
        },
        {
          cat: "해변가기",
          ko: "저는 여름 휴가 때 해변 근처 숙소를 예약해요.",
          en: "I book accommodation near the beach for summer vacation.",
          tip: "'book accommodation'은 숙소를 예약한다는 뜻이에요.",
        },
        {
          cat: "해변가기",
          ko: "저는 바다를 좋아해요.",
        ...
        },
        {
          ...
          tip: "'go to the beach'로 해변에 간다는 뜻을 표현해요.",
        },

        {
          ...
          tip: "'go jogging'은 조깅을 한다는 뜻이에요.",
        },
        {
          cat: "조깅하기",
          ko: "저는 집 근처 강변을 따라 뛰어요.",
          en: "I run along the riverside near my house.",
          tip: "'run along the riverside'로 장소를 표현해요.",
        },
        {
          cat: "조깅하기",
          ko: "저는 조깅할 때 음악을 들어요.",
          en: "I listen to music when I go jogging.",
          tip: "'when + 주어 + 동사'로 상황을 붙여요.",
        },
        {
          cat: "조깅하기",
          ko: "저는 보통 30분 정도 조깅을 해요.",
          en: "I usually jog for about 30 minutes.",
          tip: "'for + 시간'으로 지속 시간을 표현해요.",
        },
        {
          cat: "조깅하기",
          ko: "저는 조깅한 후에 스트레칭을 해요.",
          en: "I stretch after I go jogging.",
          tip: "'after + 주어 + 동사'로 순서를 나타내요.",
        },
        {
          cat: "조깅하기",
          ko: "저는 조깅할 때 운동화를 편한 것으로 신어요.",
          en: "I wear comfortable sneakers when I go jogging.",
          tip: "'comfortable sneakers'로 편한 운동화를 표현해요.",
        },
        {
          cat: "조깅하기",
          ko: "저는 조깅 앱으로 거리를 기록해요.",
          en: "I track my distance with a jogging app.",
          tip: "'track + 명사'로 기록한다는 뜻을 나타내요.",
        },
        {
          cat: "조깅하기",
          ko: "저는 조깅을 좋아해요.",
        ...
        },
        {
          ...
          tip: "'in the morning'은 아침에라는 뜻이에요.",
        },

        {
          ...
          ko: "저는 걷는 것을 좋아해요.",
          en: "I like walking.",
          tip: "'like walking'으로 간단히 말해요.",
        },
        {
          cat: "걷기",
          ko: "저는 시간이 있을 때 동네를 걸어 다녀요.",
          en: "I walk around the neighborhood when I have time.",
          tip: "'walk around'는 이곳저곳 걸어 다닌다는 뜻이에요.",
        },
        {
          cat: "걷기",
          ko: "저는 매일 만 보 이상 걸으려고 노력해요.",
          en: "I try to walk more than 10,000 steps every day.",
          tip: "'try to + 동사원형'으로 노력을 표현해요.",
        },
        {
          cat: "걷기",
          ko: "저는 걸으면서 생각을 정리하는 것을 좋아해요.",
          en: "I like organizing my thoughts while I walk.",
          tip: "'while + 주어 + 동사'로 동시 동작을 나타내요.",
        },
        {
          cat: "걷기",
          ko: "저는 대중교통 대신 걸어서 출근할 때도 있어요.",
          en: "Sometimes I walk to work instead of taking public transportation.",
          tip: "'instead of -ing'로 대안을 표현해요.",
        },
        {
          cat: "걷기",
          ko: "저는 걷는 속도가 빠른 편이에요.",
          en: "I tend to walk fast.",
          tip: "'tend to'로 성향을 부드럽게 표현해요.",
        },
        {
          cat: "걷기",
          ko: "저는 걸을 때 편한 신발을 신어요.",
          en: "I wear comfortable shoes when I walk.",
          tip: "'comfortable shoes'는 편한 신발이라는 뜻이에요.",
        },
        {
          cat: "걷기",
          ko: "저는 매일 걸어요.",
          en: "I walk every day.",
          tip: "'every day'로 매일이라는 뜻을 표현해요.",
        },
        {
          cat: "걷기",
          ko: "저는 산책을 좋아해요.",
          en: "I like taking walks.",
          tip: "'take a walk'는 산책한다는 뜻이에요.",
        },
      ];

      const CATEGORIES = [...new Set(SENTENCES.map((s) => s.cat))];
      ...
      const WORD_ITEMS = [
        {
          ...
          options: ["in", "on", "at"],
          answer: "at",
          tip: "at은 정확한 시각 앞에 써요. 예) at 7, at noon, at midnight.",
        },
        {
          cat: "전치사",
          prompt: "연도나 계절 앞에 쓰는 전치사는?",
          options: ["in", "on", "at"],
          answer: "in",
          tip: "in은 연도, 계절 앞에 써요. 예) in 1995, in summer.",
        },
        {
          cat: "전치사",
          prompt: "월(月) 이름 앞에 쓰는 전치사는?",
          options: ["in", "on", "at"],
          answer: "in",
          tip: "in은 월 이름 앞에 써요. 예) in March, in December.",
        },
        {
          cat: "전치사",
          prompt: "요일이나 날짜 앞에 쓰는 전치사는?",
          options: ["in", "on", "at"],
          answer: "on",
          tip: "on은 요일, 날짜 앞에 써요. 예) on Monday, on May 5th.",
        },
        {
          cat: "전치사",
          prompt: "'~부터 지금까지'라는 뜻을 가진 전치사는?",
          options: ["since", "for", "during"],
          answer: "since",
          tip: "since는 특정 시점부터 지금까지라는 뜻이에요. 예) since 2010.",
        },
        {
          cat: "전치사",
          prompt: "기간의 길이를 나타내는 전치사는?",
          options: ["since", "for", "during"],
          answer: "for",
          tip: "for는 지속된 기간의 길이를 말할 때 써요. 예) for three years.",
        },
        {
          cat: "전치사",
          prompt: "명사와 함께 써서 '~하는 동안'을 나타내는 전치사는?",
          options: ["during", "for", "while"],
          answer: "during",
          tip: "during 뒤에는 명사가 와요. 예) during the meeting. (while 뒤에는 절이 와요)",
        },
        {
          cat: "전치사",
          prompt: "'~사이에(둘 사이)'라는 뜻을 가진 전치사는?",
          options: ["between", "among", "during"],
          answer: "between",
          tip: "between은 둘 사이, among은 셋 이상 사이라는 뜻이에요.",
        },
        {
          cat: "전치사",
          prompt: "'~을 위한'이라는 뜻을 가진 전치사는?",
          options: ["for", "to", "with"],
          answer: "for",
          tip: "for는 '~을 위한, ~을 향한'이라는 뜻이에요. 예) This gift is for you.",
        },
        {
          cat: "전치사",
          prompt: "'~에 관심이 있다'라고 할 때 함께 쓰는 전치사는?",
          options: ["in", "on", "at"],
          answer: "in",
          tip: "'be interested in'은 통째로 외워두는 표현이에요.",
        },
        {
          cat: "전치사",
          prompt: "'~을 기대하다(look forward)' 뒤에 쓰는 전치사는?",
          options: ["to", "for", "at"],
          answer: "to",
          tip: "'look forward to' 뒤에는 명사나 동명사가 와요. 예) look forward to seeing you.",
        },

        {
          cat: "접속사",
          prompt: "결과를 나타낼 때 쓰는 접속사는?",
          options: ["so", "but", "because"],
          answer: "so",
          tip: "so는 앞 내용의 결과를 이어줘요. 예) I was tired, so I went to bed early.",
        },
        {
          cat: "접속사",
          prompt: "대조되는 내용을 이을 때 쓰는 접속사는?",
          options: ["but", "so", "and"],
          answer: "but",
          tip: "but은 앞뒤가 대조될 때 써요. 예) I like coffee, but I don't drink it every day.",
        },
        {
          cat: "접속사",
          prompt: "이유를 나타낼 때 쓰는 접속사는?",
          options: ["because", "so", "although"],
          answer: "because",
          tip: "because 뒤에는 이유가 와요. 예) I stayed home because it was raining.",
        },
        {
          cat: "접속사",
          prompt: "양보(그럼에도 불구하고)를 나타낼 때 쓰는 접속사는?",
          options: ["although", "because", "so"],
          answer: "although",
          tip: "although는 '비록 ~이지만'이라는 뜻이에요. 예) Although it was raining, I went for a walk.",
        },
        {
          cat: "접속사",
          prompt: "시간(~할 때)을 나타낼 때 쓰는 접속사는?",
          options: ["when", "although", "but"],
          answer: "when",
          tip: "when은 특정 시점을 나타내요. 예) I'll call you when I arrive.",
        },
        {
          cat: "접속사",
          prompt: "'~하지 않는 한'이라는 뜻을 가진 접속사는?",
          options: ["unless", "so", "but"],
          answer: "unless",
          tip: "unless는 '~하지 않는 한'이라는 조건을 나타내요.",
        },
        {
          cat: "접속사",
          prompt: "단순히 내용을 나열할 때 쓰는 접속사는?",
          options: ["and", "or", "but"],
          answer: "and",
          tip: "and는 내용을 그대로 나열할 때 써요. 예) I like both tea and coffee.",
        },
        {
          cat: "접속사",
          prompt: "선택지를 제시할 때 쓰는 접속사는?",
          options: ["or", "and", "but"],
          answer: "or",
          tip: "or는 둘 중 하나를 고를 때 써요. 예) Would you like tea or coffee?",
        },
        {
          cat: "접속사",
          prompt:
            "동시에 일어나는 동작을 이어줄 때 쓰는 접속사는? (뒤에 절이 옴)",
          options: ["while", "because", "so"],
          answer: "while",
          tip: "while 뒤에는 절(주어+동사)이 와요. 예) I was watching TV while she was cooking.",
        },
        {
          cat: "접속사",
          prompt: "순서상 '~하기 전에'라는 뜻을 가진 접속사는?",
          options: ["before", "and", "so"],
          answer: "before",
          tip: "before는 순서를 나타내요. 예) I'll finish this before I go home.",
        },

        {
          cat: "기타 자주 쓰는 표현",
          prompt: "셀 수 없는 명사의 많음을 나타낼 때 쓰는 표현은?",
          options: ["many", "much", "a"],
          answer: "much",
          tip: "much는 셀 수 없는 명사(money, water 등) 앞에 써요.",
        },
        {
          cat: "기타 자주 쓰는 표현",
          prompt: "셀 수 있는 명사의 많음을 나타낼 때 쓰는 표현은?",
          options: ["much", "many", "a lot"],
          answer: "many",
          tip: "many는 셀 수 있는 명사(friends, books 등) 앞에 써요.",
        },
        {
          cat: "기타 자주 쓰는 표현",
          prompt: "셀 수 있는/없는 명사 둘 다에 쓸 수 있는 '많음' 표현은?",
          options: ["a lot", "much", "many"],
          answer: "a lot",
          tip: "'a lot of'는 셀 수 있는/없는 명사 둘 다 쓸 수 있어요.",
        },
        {
          cat: "기타 자주 쓰는 표현",
          prompt: "부정문 뒤에서 '~도 그렇다'라고 동의할 때 쓰는 표현은?",
          options: ["either", "too", "also"],
          answer: "either",
          tip: "부정문 뒤에서 동의할 때는 either를 써요. 예) I don't like it, either.",
        },
        {
          cat: "기타 자주 쓰는 표현",
          prompt: "긍정문 뒤에서 '~도 그렇다'라고 동의할 때 쓰는 표현은?",
          options: ["too", "either", "so"],
          answer: "too",
          tip: "긍정문 뒤에서 동의할 때는 too를 써요. 예) I like it, too.",
        },
        {
          cat: "기타 자주 쓰는 표현",
          prompt: "동사 앞에서 '~도 역시'라는 뜻으로 쓰는 표현은?",
          options: ["also", "either", "too"],
          answer: "also",
          tip: "also는 보통 동사 앞에 위치해요. 예) I also like pizza.",
        },
        {
          cat: "기타 자주 쓰는 표현",
          prompt: "셀 수 없는 명사의 소량을 나타낼 때 쓰는 표현은?",
          options: ["a few", "a little", "many"],
          answer: "a little",
          tip: "a little은 셀 수 없는 명사의 소량을 나타내요.",
        },
        {
          cat: "기타 자주 쓰는 표현",
          prompt: "셀 수 있는 명사의 소량을 나타낼 때 쓰는 표현은?",
          options: ["a little", "a few", "much"],
          answer: "a few",
          tip: "a few는 셀 수 있는 명사의 소량을 나타내요.",
        },
        {
          cat: "기타 자주 쓰는 표현",
          prompt: "단수 명사가 있다고 말할 때 쓰는 표현은?",
          options: ["is", "are", "be"],
          answer: "is",
          tip: "단수 명사 앞에서는 'There is'를 써요.",
        },
        {
          cat: "기타 자주 쓰는 표현",
          prompt: "복수 명사가 있다고 말할 때 쓰는 표현은?",
          options: ["is", "are", "be"],
          answer: "are",
          tip: "복수 명사 앞에서는 'There are'를 써요.",
        },
        ...
        {
          cat: "관사",
          prompt: "'apple'처럼 모음 소리로 시작하는 단어 앞에 쓰는 관사는?",
          options: ["a", "an", "the"],
          answer: "an",
          tip: "모음 발음(a, e, i, o, u 소리)으로 시작하는 단어 앞에는 an을 써요.",
        },
        {
          cat: "관사",
          prompt:
            "'dog'처럼 자음 소리로 시작하고 처음 언급하는 단어 앞에 쓰는 관사는?",
          options: ["a", "an", "the"],
          answer: "a",
          tip: "자음 소리로 시작하고 처음 언급하는 하나는 a를 써요.",
        },
        {
          cat: "관사",
          prompt: "'태양'처럼 세상에 하나뿐인 것 앞에 쓰는 관사는?",
          options: ["a", "an", "the"],
          answer: "the",
          tip: "세상에 하나뿐인 것 앞에는 the를 써요. 예) The sun rises in the east.",
        },
        {
          cat: "관사",
          prompt: "악기 이름 앞에 보통 쓰는 관사는?",
          options: ["a", "an", "the"],
          answer: "the",
          tip: "악기 이름 앞에는 보통 the를 써요. 예) play the guitar.",
        },
        {
          cat: "관사",
          prompt:
            "'engineer'처럼 모음 소리로 시작하는 직업명 앞에 쓰는 관사는?",
          options: ["a", "an", "the"],
          answer: "an",
          tip: "직업이 모음 소리로 시작하면 an을 써요.",
        },
        {
          cat: "관사",
          prompt: "'umbrella'처럼 모음 소리로 시작하는 단어 앞에 쓰는 관사는?",
          options: ["a", "an", "the"],
          answer: "an",
          tip: "umbrella는 모음 소리로 시작해서 an을 써요.",
        },
        {
          cat: "관사",
          prompt: "최상급(가장 ~한) 표현 앞에 쓰는 관사는?",
          options: ["a", "an", "the"],
          answer: "the",
          tip: "최상급 앞에는 the를 써요. 예) the tallest student.",
        },
        {
          cat: "관사",
          prompt: "'book'처럼 특정하지 않은 하나를 말할 때 쓰는 관사는?",
          options: ["a", "an", "the"],
          answer: "a",
          tip: "특정하지 않은 하나는 a를 써요.",
        },
        {
          cat: "관사",
          prompt: "서로 이미 알고 있는 특정한 것을 가리킬 때 쓰는 관사는?",
          options: ["a", "an", "the"],
          answer: "the",
          tip: "서로 알고 있는 특정한 것은 the를 써요. 예) Can you pass me the salt?",
        },
        {
          cat: "관사",
          prompt: "'doctor'처럼 자음 소리로 시작하는 직업명 앞에 쓰는 관사는?",
          options: ["a", "an", "the"],
          answer: "a",
          tip: "doctor는 자음 소리로 시작해서 a를 써요.",
        },

        {
          cat: "시제",
          prompt: "나는 매일 아침을 먹어요.",
          options: ["eat", "ate", "eaten"],
          answer: "eat",
          tip: "반복되는 습관은 현재시제를 써요. 예) I eat breakfast every morning.",
        },
        {
          cat: "시제",
          prompt: "나는 어제 저녁을 먹었어요.",
          options: ["eat", "ate", "eaten"],
          answer: "ate",
          tip: "어제(yesterday)처럼 명확한 과거 시점은 과거시제를 써요.",
        },
        {
          cat: "시제",
          prompt: "나는 점심을 이미 다 먹었어요.",
          options: ["eat", "ate", "eaten"],
          answer: "eaten",
          tip: "'have + 과거분사'는 현재완료예요. 예) I have already eaten lunch.",
        },
        {
          cat: "시제",
          prompt: "그녀는 작년에 부산에 갔어요.",
          options: ["go", "went", "gone"],
          answer: "went",
          tip: "작년(last year)처럼 명확한 과거 시점은 과거시제를 써요.",
        },
        {
          cat: "시제",
          prompt: "나는 일본에 가본 적이 한 번도 없어요.",
          options: ["go", "been", "gone"],
          answer: "been",
          tip: "경험을 말할 때는 'have been to'를 써요. 'have gone to'는 '가버려서 지금 여기 없다'는 뜻이 돼요.",
        },
        {
          cat: "시제",
          prompt: "그는 지금 TV를 보고 있어요.",
          options: ["watch", "watched", "is watching"],
          answer: "is watching",
          tip: "지금 진행 중인 동작은 현재진행형을 써요.",
        },
        {
          cat: "시제",
          prompt: "나는 2020년부터 여기 살고 있어요.",
          options: ["live", "lived", "have lived"],
          answer: "have lived",
          tip: "since와 함께 계속되는 상태는 현재완료를 써요.",
        },
        {
          cat: "시제",
          prompt: "그들은 주말마다 축구를 해요.",
          options: ["play", "played", "playing"],
          answer: "play",
          tip: "반복되는 습관은 현재시제를 써요.",
        },
        {
          cat: "시제",
          prompt: "나는 어제 저녁 먹기 전에 숙제를 끝냈어요.",
          options: ["finish", "finished", "have finished"],
          answer: "finished",
          tip: "yesterday처럼 명확한 과거 시점은 과거시제를 써요.",
        },
        {
          cat: "시제",
          prompt: "나는 지금까지 이 영화를 세 번 봤어요.",
          options: ["watch", "watched", "have watched"],
          answer: "have watched",
          tip: "횟수를 말하는 경험은 현재완료를 써요.",
        },

        {
          cat: "비교급/최상급",
          prompt: "이 책이 저 책보다 더 재미있어요.",
          options: ["interesting", "more interesting", "most interesting"],
          answer: "more interesting",
          tip: "긴 형용사의 비교급은 more를 붙여요.",
        },
        {
          cat: "비교급/최상급",
          prompt: "그녀는 반에서 가장 똑똑한 학생이에요.",
          options: ["smart", "smarter", "smartest"],
          answer: "smartest",
          tip: "최상급은 -est를 붙이고 the를 함께 써요.",
        },
        {
          cat: "비교급/최상급",
          prompt: "오늘이 어제보다 더 더워요.",
          options: ["hot", "hotter", "hottest"],
          answer: "hotter",
          tip: "짧은 형용사의 비교급은 -er을 붙여요.",
        },
        {
          cat: "비교급/최상급",
          prompt: "이곳이 마을에서 제일 좋은 식당이에요.",
          options: ["good", "better", "best"],
          answer: "best",
          tip: "good의 최상급은 best예요 (불규칙 변화).",
        },
        {
          cat: "비교급/최상급",
          prompt: "내 차가 그의 차보다 더 빨라요.",
        ...
        {
          cat: "비교급/최상급",
          prompt: "그가 나보다 키가 더 커요.",
          options: ["tall", "taller", "tallest"],
          answer: "taller",
          tip: "두 대상을 비교할 때는 비교급을 써요.",
        },
        {
          cat: "비교급/최상급",
          prompt: "이건 내가 본 영화 중 최악이에요.",
          options: ["bad", "worse", "worst"],
          answer: "worst",
          tip: "bad의 최상급은 worst예요 (불규칙 변화).",
        },
        {
          cat: "비교급/최상급",
          prompt: "그녀는 남동생보다 더 빨리 달려요.",
          options: ["fast", "faster", "fastest"],
          answer: "faster",
          tip: "두 대상을 비교할 때는 비교급을 써요.",
        },
        {
          cat: "비교급/최상급",
          prompt: "이 시험은 제가 예상했던 것보다 더 어려웠어요.",
        ...
        {
          cat: "대명사",
          prompt: "그는 제 가장 친한 친구예요.",
          options: ["He", "Him", "His"],
          answer: "He",
          tip: "주어 자리에는 주격 대명사(He)를 써요.",
        },
        {
          cat: "대명사",
          prompt: "나는 그에게 책을 줬어요.",
          options: ["he", "him", "his"],
          answer: "him",
          tip: "목적어 자리에는 목적격 대명사(him)를 써요.",
        },
        {
          cat: "대명사",
          prompt: "이건 그의 차예요.",
          options: ["he", "him", "his"],
          answer: "his",
          tip: "명사 앞에서 소유를 나타낼 때는 소유격(his)을 써요.",
        },
        {
          cat: "대명사",
          prompt: "그녀와 나는 영화를 보러 갔어요.",
          options: ["She", "Her", "Hers"],
          answer: "She",
          tip: "주어 자리에는 주격 대명사(She)를 써요.",
        },
        {
          cat: "대명사",
          prompt: "저 좀 도와주실 수 있나요?",
          options: ["I", "me", "my"],
          answer: "me",
          tip: "목적어 자리에는 목적격 대명사(me)를 써요.",
        },
        {
          cat: "대명사",
          prompt: "저 가방은 제 거예요.",
          options: ["my", "mine", "me"],
          answer: "mine",
          tip: "'나의 것'은 소유대명사(mine)를 써요.",
        },
        {
          cat: "대명사",
          prompt: "그들의 강아지는 정말 귀여워요.",
          options: ["They", "Them", "Their"],
          answer: "Their",
          tip: "명사 앞에서 소유를 나타낼 때는 소유격(Their)을 써요.",
        },
        {
          cat: "대명사",
          prompt: "나는 어제 공원에서 그들을 봤어요.",
          options: ["they", "them", "their"],
          answer: "them",
          tip: "목적어 자리에는 목적격 대명사(them)를 써요.",
        },
        {
          cat: "대명사",
          prompt: "이 책 당신 거예요?",
          ...
          answer: "yours",
          tip: "'너의 것'은 소유대명사(yours)를 써요.",
        },
        {
          cat: "대명사",
          prompt: "그녀는 책 읽는 것을 좋아해요.",
          options: ["She", "Her", "Hers"],
          answer: "She",
          tip: "주어 자리에는 주격 대명사(She)를 써요.",
        },
        ...
        {
          cat: "부사",
          prompt: "나는 보통 아침에 커피를 마셔요.",
          options: ["usual", "usually", "use"],
          answer: "usually",
          tip: "형용사(usual)에 -ly를 붙이면 부사가 돼요. 빈도부사는 보통 일반동사 앞에 위치해요.",
        },
        {
          cat: "부사",
          prompt: "그는 빠르게 달려요.",
          ...
          answer: "quickly",
          tip: "동사를 수식할 때는 부사(quickly)를 써요.",
        },
        {
          cat: "부사",
          prompt: "이 케이크는 정말 맛있어요.",
          options: ["real", "really", "reality"],
          answer: "really",
          tip: "형용사를 강조할 때는 부사 really를 써요.",
        },
        {
          cat: "부사",
          prompt: "나는 그를 잘 알아요.",
          ...
          answer: "well",
          tip: "good의 부사형은 well이에요 (불규칙 변화).",
        },
        {
          cat: "부사",
          prompt: "나는 항상 아침 7시에 일어나요.",
          options: ["always", "all", "almost"],
          answer: "always",
          tip: "빈도부사(always)는 보통 일반동사 앞, be동사 뒤에 위치해요.",
        },
        {
          cat: "부사",
          prompt: "그녀는 그 소식을 듣고 매우 놀랐어요.",
          options: ["very", "so", "too"],
          answer: "very",
          tip: "형용사(surprised)를 꾸밀 때는 very를 써요.",
        },
        {
          cat: "부사",
          prompt: "이 문제는 너무 어려워서 풀 수 없어요.",
          options: ["very", "too", "so"],
          answer: "too",
          tip: "'너무 ~해서 할 수 없다'는 부정적 뉘앙스는 too를 써요.",
        },
        {
          cat: "부사",
          prompt: "이 가방은 충분히 커요.",
          ...
          answer: "enough",
          tip: "enough는 형용사 뒤에 위치해요. 예) big enough. (very, too는 형용사 앞에 와요)",
        },
        {
          cat: "부사",
          prompt: "그는 조용히 방을 나갔어요.",
          options: ["quiet", "quietly", "quietness"],
          answer: "quietly",
          tip: "동작을 어떻게 했는지 설명할 때는 부사(quietly)를 써요.",
        },
        {
          cat: "부사",
          prompt: "나는 가끔 늦게까지 일해요.",
          options: ["sometimes", "sometime", "some"],
          answer: "sometimes",
      ...
      function renderChips() {
        ...
        allBtn.className =
          "chip all" +
          (selectedCats.size === CATEGORIES.length ? " active" : "");
      ...
      function loadTtsSettings() {
        try {
          ...
          if (savedAutoPlay !== null)
            autoPlayTtsEnabled = savedAutoPlay === "true";
        } catch (e) {}
        updateTtsSettingsUI();
      }
      ...
      function updateTtsSettingsUI() {
        ...
        document.querySelectorAll(".speed-chip").forEach((btn) => {
          ...
          btn.classList.toggle(
            "active",
            Math.abs(speed - currentTtsRate) < 0.05,
          );
        });
      }
      ...
      function getBestVoice(lang = "en-US") {
        ...
        if (lang.startsWith("en")) {
          const enVoices = ttsVoices.filter(
          ...
          const koVoices = ttsVoices.filter(
            (v) => v.lang && v.lang.startsWith("ko"),
          );
          const preferred =
      ...
      function evaluateSpeech(userInput, modelAnswer) {
        ...
        const precision = inputWords.length
          ? matchCount / inputWords.length
          : 0;
      ...
      const WORD_CATEGORIES = [...new Set(WORD_ITEMS.map((w) => w.cat))];
      ...
      function renderWordChips() {
        ...
        WORD_CATEGORIES.forEach((cat) => {
          const chip = document.createElement("div");
          chip.className =
            "chip" + (wordSelectedCats.has(cat) ? " active" : "");
          chip.textContent = cat;
          chip.onclick = () => {
        ...
        const count = WORD_ITEMS.filter((w) =>
          wordSelectedCats.has(w.cat),
        ).length;
        els.wordTopicCount.textContent = wordSelectedCats.size
          ? `(${count}문제)`
          : "(유형을 선택하세요)";
        els.wordStartBtn.disabled = wordSelectedCats.size === 0;
        els.wordStartBtn.style.opacity =
          wordSelectedCats.size === 0 ? ".45" : "1";
      ...
      function renderWordCard() {
        ...
        if (wordCur >= wordOrder.length) {
          ...
          const good = wordOrder.filter(
            (idx) => wordResults[idx] === "good",
          ).length;
          const wrongIndices = wordOrder.filter(
            (idx) => wordResults[idx] === "bad",
          );
      ...
      <div class="bar-label">${d.label}</div>
        ...
        const wordResumable =
          wordOrder.length > 0 && wordCur < wordOrder.length;
